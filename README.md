...
Once the `conda-forge` channel has been enabled, `yank` can be installed with:

```
conda install yank
```

It is possible to list all of the versions of `yank` available on your platform with:
